...
import 'package:teamtodo/src/core/http/app_interceptor.dart';
import 'package:teamtodo/src/core/utils/env.dart';
import 'package:teamtodo/src/core/utils/local_storage.dart';
...
class HttpClient {
  ...
  void _initClient() {
    _dio.interceptors.add(
        DioCacheManager(CacheConfig(baseUrl: env(EnvKey.MIMOSI_BASE_URL)))
            .interceptor);
